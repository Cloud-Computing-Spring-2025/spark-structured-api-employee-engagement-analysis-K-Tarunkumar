...
def main():
    ...
    input_file = "/workspaces/spark-structured-api-employee-engagement-analysis-K-Tarunkumar/input/employee_data.csv"
    output_file = "/workspaces/spark-structured-api-employee-engagement-analysis-K-Tarunkumar/outputs/task1/departments_high_satisfaction.csv"
